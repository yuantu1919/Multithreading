...
public class KThread {
	...
	public static void finish() {
		...
		KThread joinThread = currentThread.joinQueue.nextThread();
		while(joinThread != null)
		{
			joinThread.ready();
			joinThread = currentThread.joinQueue.nextThread();
		}
		currentThread.joinQueue = null;
		//Machine.interrupt().restore(intStatus);
		//System.out.println(intStatus+","+Machine.interrupt().disabled());
		sleep();
	}
	...
	public void join() {
		...
		//disable interrupt
		boolean intStatus = Machine.interrupt().disable();
		//do not need to wait if thread is already finished 
